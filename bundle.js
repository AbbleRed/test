...
var unselected = "#6b6b6b" // unselected colour
var selected = "#99e339" // selected colour
var serverid = "a1" // make sure this is same as server1
var serverat = "magic-dent-message.glitch.me" // make sure this is same as server1
...
function unselect() {
  ...
  document.getElementById("s5").style.color = unselected;
}
// servers
function server1select() {
  ...
  servertype = "4tdm"
  serverat = "magic-dent-message.glitch.me" // server
  servercode = "4tdm"
  serverid = "a1"
}
...
serverat = "modern-receptive-princess.glitch.me" //server
servertype = "2tdm domination"
serverid = "b2";
}
...
serverat = "subsequent-rebel-caribou.glitch.me" //server
servertype = "4tdm domination"
serverid = "c3";
}
function server4select() {
  unselect()
  document.getElementById("s4").style.color = "#99e339";

serverat = "glass-immediate-deerstalker.glitch.me" //server
servertype = "maze"
serverid = "d4";
}
function server5select() {
  unselect()
  document.getElementById("s5").style.color = "#99e339";

serverat = "synonymous-sticky-result.glitch.me" //server
servertype = "frost land"
serverid = "e5";
}
// the rest lel
~ function() {
        ...
        return p(p.s = 0)
            ...
            function t() {
                if (!ua) {
                    ...
                    if (!b.socket) {
                        ...
                        let a = `${1===(b.server.secure||d)?"https":"http"}://${serverat}/mockups.json`,
            ...
            function Qa(b, a, c, h, u) {
                if (!(.05 > u)) {
                  ...
                  if (somethinglolcuzimlazy == "DeveloperToken8002#real") {
                    c.nameplate && c.id !== A.playerid && (null == c.render.textobjs && (c.render.textobjs = [m(), m()]), d = c.name, f = l.yellow, !1 &&
                        (d = d.slice(2), d.length && (f = T(l.magenta, f, .125))), g.globalAlpha = u, c.render.textobjs[0].draw(d, b, a - h - 30, 16, f, "center"), c.render.textobjs[1].draw(H.handleLargeNumber(c.score, !0), b, a - h - 16, 8, f, "center"), g.globalAlpha = 1) } else {
                      c.nameplate && c.id !== A.playerid && (null == c.render.textobjs && (c.render.textobjs = [m(), m()]), d = c.name, f = l.guiwhite, z.key == somethinglolcuzimlazy &&
                        (d = d.slice(2), d.length && (f = T(l.magenta, f, .125))), g.globalAlpha = u, c.render.textobjs[0].draw(d, b, a - h - 30, 16, f, "center"), c.render.textobjs[1].draw(H.handleLargeNumber(c.score, !0), b, a - h - 16, 8, f, "center"), g.globalAlpha = 1)
                ...
                A = {
                    getStatNames: b => {
                        switch (b) {
                            ...
                            case 7:
                                return "Body Damage;Max Health;Placement Speed;Block Health;Block Penetration;Block Damage;Reload;Movement Speed;Shield Regeneration;Shield Capacity".split(";");
                            default:
            ...
            const Pa = (() => {
                    ...
                    e = (() => {
                        ...
                        return {
                            ...
                            gui: () => {
                                ...
                                k && (A.accel = a.next());
                                x && (A.party = a.next(), "z" !== serverid && (location.hash =
                                    "#" + serverid))
                            },
                            broadcast: () => {
                                var c = a.all();
                ...
                return () => {
                    ...
                    let g = new WebSocket((1 === d ? "wss://" : "ws://") + serverat + "/");
                    ...
                    g.onclose = function(a) {
                        ...
                        g.open = !1;
                        b.disconnected = !0;
                        b.isInGame && (b.isInGame = !1, b.died || b.message || (b.message = "Sockets closed. Please try again later"));
                        console.warn("WebSocket closed: ",
                            a)
                    };
                    g.onerror = function(a) {
                        console.warn("WebSocket error", a);
                        b.message || (b.message = "Socket error. Please try again later.");
                        b.isInGame = !1
                    };
                    return g
                }
                    ...
                    return (a, c, d, x, t = 1, f = 1, m = 0, p = !1, z = !1, q = !1, F = d.render) => {
                        ...
                        if (0 !== u && 0 !== t) {
                            ...
                            if (q.guns.length === n.guns.length)
                                ...
                                } else throw Error("Mismatch gun number with mockup."); // just remix it
                            h.globalAlpha = 1;
                            k(h, E);
            ...
            const Ra = (() => {
                    ...
                    return c => {
                        ...
                        if (!b.hideGui) {
                            ...
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("diras.io", h + 200, m - 2, 15, l.guiwhite, "right");
                                else {
                                    if (b.showDebug) {
                                        W[6].draw("diras.io", h + 200, m - 84 - 2, 15, l.green, "right");
                                        let b = t.getPeriodicAverage();
                                        W[5].draw("Tank's Speed: " + y.toFixed(2) + " gu/s" + (b && .005 <= b ? ` (${b.toFixed(2)} gu/s)` : ""), h + 200, m - 70, 10, l.guiwhite, "right");
                                    ...
                                    } else W[6].draw("diras.io", h + 200, m - 42 - 2, 15, l.green, "right");
                                  b.showDebug = !0;
                                    ...
                                    W[0].draw(v.toFixed(1) + " ms  " + servercode + " :" + servertype + ":", h + 200, m, 10, l.guiwhite, "right")
                                }
                            }
                            b.mobile && L(1.25);
                            b.mobile && L(1.4);
                            if (!B.graphical.screenshotMode) {
                                ...
                                for (let a = 0; a < O.data.length && (!b.mobile || 6 > a); a++) {
                                    ...
                                    //if (b.label.includes('[AI]'))ca[a].draw(b.label + ": " + I.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.green, "center", !0);
                                    ...
                                    d += 18
                                    //if (d.startsWith("DeveloperToken8002#real")) ca[a].draw(b.label + ": " + I.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "#FFF799", "center", !0);
                                }
                            }
                            b.mobile && L(1 / 1.4); {
                ...
                Ta = (() => {
                    ...
                    return () => {
                        ...
                        a.draw("Lol you dead", d, n - 80, 8, l.guiwhite, "center");
                        e.draw("Level " +
            ...
            const Sa = (() => {
                    ...
                    m();
                    var c = [
                        ["Tip: You can view and edit your keybinds in the options menu.", "Tip: You can play on mobile by just going to diras.io on your phone!"],
                        ["Tip: You can have the shield and health bar be separated by going to the options menu.", "Tip: If diras.io is having a low frame rate, you can try enabling low graphics in the options menu.", "Tip: You can make traps rounded with the classic trap setting in the options menu.", "Tip: You can create your own private server with the template in the link on the options menu.", "Tip: You can create your own theme with the custom theme makerin the link on the options menu."],
                        ["Tip: You can join diras.io discord! Link in options.", "Tip: diras.io is developed by Abble!", "Tip: If you cant connect to the page, please wait and try later", "Enjoy your playing time ;)", "Nothing here.", "diras.io"],
                        ["Tip: Refresh the page if its look suck.", "Hows going?", "Tip: If disconnected, you can regain your scores by reconnect it early!", "You still looking at this???", "Idk what to say in here lol."],
            ...
            p.handleLargeNumber = (a, e = !1) => e && 0 >= a ? "" : 1E3 > a ? a.toFixed(0) + "" : 1E6 > a ? (a / 1E3).toFixed(2) + "k" : 1E9 > a ? (a /
                1E6).toFixed(2) + "m" : 1E12 > a ? (a / 1E9).toFixed(2) + "b" : 1E15 > a ? (a / 1E12).toFixed(2) + "t" : 1E18 > a ? (a / 1E15).toFixed(2) + "qa" : 1E21 > a ? (a / 1E18).toFixed(2) + "qi" : 1E24 > a ? (a / 1E21).toFixed(2) + "se" : 1E27 > a ? (a / 1E24).toFixed(2) + "sep" : 1E30 > a ? (a / 1E27).toFixed(2) + "oc" 
            : 1E33 > a ? (a / 1E30).toFixed(2) + "non" : 1E36 > a ? (a / 1E33).toFixed(2) + "de" : 1E39 > a ? (a / 1E36).toFixed(2) + "unde" : 1E42 > a ? (a / 1E39).toFixed(2) + "duode" : 1E44 > a ? (a / 1E42).toFixed(2) + "trede" : 
            a;
            p.timeForHumans = a => {
                function e(a, e) {
                    a && (D = D + ("" === D ? "" : ", ") + a + " " + e + (1 < a ? "s" : ""))
